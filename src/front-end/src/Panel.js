...
// Envoi de la balise html
    if (gltf) {
      return (
        ...
        {isPanel ? (
          <mesh ref={panelRef} >
            <mesh
                ...
                onClick={()=>{Click(loaderGltf.scene.rotation.y)}}
            />
        ...
        <Pong stateGame={props.state} updateSetState={props.updateSetState} formData8={props.formData8} formData4={props.formData4} formData2={props.formData2} winnerTournament={props.winnerTournament} score={props.score} updateSetScore={props.updateSetScore} racketColor={props.racketColor} selectedKeys={props.selectedKeys}/>
      </>
      ) 
    } else {
      return null;
